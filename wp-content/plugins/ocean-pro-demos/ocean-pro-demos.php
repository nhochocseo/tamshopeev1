...
final class Ocean_Pro_Demos {
	...
	public static function get_pro_demos( $data ) {
		...
		$data['barber'] = array(
			...
			'theme_settings' 	=> $url . 'barber/oceanwp-export.json',
		...
		$data['bright'] = array(
			...
			'theme_settings' 	=> $url . 'bright/oceanwp-export.json',
		...
		$data['computer'] = array(
			...
			'theme_settings' 	=> $url . 'computer/oceanwp-export.json',
		...
		$data['florist'] = array(
			...
			'theme_settings' 	=> $url . 'florist/oceanwp-export.json',
		...
		$data['freelance'] = array(
			...
			'theme_settings' 	=> $url . 'freelance/oceanwp-export.json',
		...
		$data['scuba'] = array(
			...
			'theme_settings' 	=> $url . 'scuba/oceanwp-export.json',
		...
		$data['school'] = array(
			...
			'theme_settings' 	=> $url . 'school/oceanwp-export.json',
