var WPPChart = (function() {
    ...
    var populate = function( data ){
        ...
        if ( 'undefined' != typeof wpp_chart_comments_color && wpp_chart_comments_color ) {
            var rgb_comments = HexToRGB(wpp_chart_comments_color);
            config.data.datasets[1].backgroundColor = "rgba( " + rgb_comments.r + ", " + rgb_comments.g + ", " + rgb_comments.b + ", 0.9 )";
            config.data.datasets[1].borderColor = wpp_chart_comments_color;
            config.data.datasets[1].pointBorderColor = wpp_chart_comments_color;
            config.data.datasets[1].pointHoverBackgroundColor = wpp_chart_comments_color;
            config.data.datasets[1].pointHoverBorderColor = wpp_chart_comments_color;
        }

        if ( 'undefined' != typeof wpp_chart_views_color && wpp_chart_views_color ) {
            var rgb_views = HexToRGB(wpp_chart_views_color);
            ...
            config.data.datasets[0].pointBorderColor = wpp_chart_views_color;
            config.data.datasets[0].pointHoverBackgroundColor = wpp_chart_views_color;
            config.data.datasets[0].pointHoverBorderColor = wpp_chart_views_color;
        }
